...
-- lemma C_mul_C (a a' : R) : C a * C a' = (C (a * a') : MvPolynomial σ R)  := 
-- begin
--   simp,
-- end
...
-- -- lemma rearrange1 (n : ℕ) (v1 v2 : σ) (p : MvPolynomial σ R) : (MvPolynomial.X v1 ^ n) * (MvPolynomial.X v2 * p) = MvPolynomial.X v2 * ((MvPolynomial.X v1 ^ n) * p) :=
-- -- begin
-- --   ring,
-- -- end

-- -- lemma rearrange2 (n : ℕ) (f : R) (v1 : σ) (p : MvPolynomial σ R) : (MvPolynomial.X v1 ^ n) * (MvPolynomial.C f * p) = MvPolynomial.C f * ((MvPolynomial.X v1 ^ n) * p) :=
-- -- begin
-- --   ring,
-- -- end
